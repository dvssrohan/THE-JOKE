...
**What it does:**
- Extracts audio and text embeddings separately with GPU memory management between steps
...
The regression maps 4 ROI activations → humor score (1–10 scale).
...
| ROI  | Full Name | Humor Role |
|------|-----------|------------|
| **TPJ** | Temporoparietal Junction | Detects violation of social expectations; theory of mind |
| **MTG** | Middle Temporal Gyrus | Processes semantic incongruity — the setup/punchline mismatch |
| **OFC** | Orbitofrontal Cortex | Encodes reward and pleasure response; audio-dependent |
| **BA45** | Broca's Area (pars triangularis) | Language complexity and syntactic ambiguity processing |
...
Jokes sourced from the **200k Short Jokes dataset** (Kaggle), stratified into:
